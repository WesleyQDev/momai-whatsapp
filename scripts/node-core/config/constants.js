...
const CORE_PATH = process.env.MOMAI_CORE_PATH || path.resolve(__dirname, '..', '..', '..', 'apps', 'momai', 'scripts', '..', '..', 'core')
const MODELS_DIR = resolveModelsDir()
const LLAMA_BIN_CANDIDATES = [
  process.env.MOMAI_LLAMA_BIN_PATH,
  path.resolve(__dirname, '..', '..', '..', 'apps', 'momai', 'scripts', 'bin', 'llama'),
...
const PROMPTS_DIR = path.resolve(__dirname, '..', '..', '..', 'apps', 'momai', 'scripts', '..', 'prompts')
