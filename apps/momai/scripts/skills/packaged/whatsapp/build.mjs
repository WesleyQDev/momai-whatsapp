...
const entries = []
if (manifest.ui?.page  && existsSync(path.join(__dirname, 'src/page.tsx')))  entries.push({ in: 'src/page.tsx',  out: 'page' })
if (manifest.ui?.panel && existsSync(path.join(__dirname, 'src/panel.tsx'))) entries.push({ in: 'src/panel.tsx', out: 'panel' })
