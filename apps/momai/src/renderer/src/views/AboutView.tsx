        ...
        <div className="max-w-5xl mx-auto w-full p-6 sm:p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <h4 className="text-[10px] font-black text-text uppercase tracking-widest mb-1">Email</h4>
            ...
            >
              ...
              <h4 className="text-[10px] font-black text-text uppercase tracking-widest mb-1">GitHub</h4>
            ...
            >
              ...
              <h4 className="text-[10px] font-black text-text uppercase tracking-widest mb-1">YouTube</h4>
              <p className="text-[9px] text-text-muted text-center opacity-50 leading-tight">
                @WesleyDev
              </p>
            </a>
