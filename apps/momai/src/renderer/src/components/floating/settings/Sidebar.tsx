...
export const Sidebar = ({
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          strokeWidth="2"
        >
          <path d="M12 2a7 7 0 0 1 7 7c0 2-.7 3.5-2 5a6 6 0 0 0-2 4v2M12 2a7 7 0 0 0-7 7c0 2 .7 3.5 2 5a6 6 0 0 1 2 4v2" />
          <path d="M12 2v20" />
          <path d="M9 9h6" />
        </svg>
      )
  ...
  return (
    <div
      className={`${compact ? 'w-40' : 'w-44'} border-r border-border/25 bg-white/[0.015] ${compact ? 'pl-4 pr-2 py-4' : 'pl-5 pr-3 py-5'} flex flex-col gap-0.5`}
    >
      {tabs.map((tab) => (
        <button
          key={tab.id}
