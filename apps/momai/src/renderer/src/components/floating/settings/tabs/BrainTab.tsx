      ...
      <div className="space-y-5">
        ...
        <div className="space-y-6 pt-2">
          ...
          <div className="space-y-3">
            ...
            {/* Toggle GPU/CPU */}
            <div className="flex items-center justify-between p-4 rounded-xl bg-black/30 border border-white/[0.05]">
              ...
              <button
                onClick={() => {
                  const isGpuActive = ['cuda', 'vulkan'].includes(
                    settings.local_backend === 'auto'
                      ? localDetails.current_local_backend || ''
                      : settings.local_backend
                  )
                  ...
                  return (
                    ...
                    >
                      <div className="flex flex-col items-start gap-0.5">
                        <span
                          className={`text-[12px] font-black uppercase tracking-tight ${isSelected ? 'text-accent' : 'text-text'}`}
                        >
                          {opt.label}
                          {opt.id === 'auto' && (
