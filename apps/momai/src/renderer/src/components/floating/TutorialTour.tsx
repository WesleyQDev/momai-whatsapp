        ...
        <div
          ...
          style={{
            left: Math.min(
              ...
              Math.max(20, spotlightRect.left + spotlightRect.width / 2 - 160)
            ),
            top:
              spotlightRect.bottom + 30 > window.innerHeight - 250
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[9px] font-black uppercase tracking-[0.2em] text-accent/80">
                  MomAI Guide
                </span>
              </div>
