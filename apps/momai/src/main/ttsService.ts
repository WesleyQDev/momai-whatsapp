  ...
  private async getEdgeVoices(): Promise<TTSVoice[]> {
    try {
      ...
      const commonVoices: TTSVoice[] = [
        ...
        { id: 'pt-BR-FranciscaNeural', name: 'Francisca (Portuguese)', language: 'pt-BR', gender: 'female' },
        { id: 'pt-BR-AntonioNeural', name: 'Antonio (Portuguese)', language: 'pt-BR', gender: 'male' },
