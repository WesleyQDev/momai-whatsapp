  ...
  return (
    <div className="mx-auto max-w-[900px] px-8 py-24">
      <div className="mb-20 text-center">
        <h1 className="mb-3 font-flex text-5xl font-normal tracking-tight text-[var(--text)]">
          {t("changelog.title")}
        </h1>
          ...
          {versions.map((v) => (
            <div key={v.version} className="relative mb-16">
              ...
              <div className="mb-2 flex items-center gap-4">
                <span className="text-base font-bold tracking-wide text-[var(--text-tertiary)]">
                  {v.version}
                </span>
                <span className="text-[0.95rem] text-[var(--text-tertiary)]">
                  {v.date}
                </span>
              </div>

              <h3 className="mb-6 text-2xl font-medium leading-[1.4] tracking-tight text-[var(--text)]">
                {v.title}
              </h3>
                  ...
                  >
                    ...
                    <ul className="relative m-0 flex flex-col gap-2 p-0">
                      {section.items.map((item, i) => (
                        <li
                          key={i}
                          className="py-1 pl-7 text-base leading-relaxed text-[var(--text-secondary)]"
                        >
