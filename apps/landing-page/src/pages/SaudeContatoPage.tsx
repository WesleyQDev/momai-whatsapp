    ...
    <div className="mx-auto max-w-[800px] px-8 py-24">
        ...
        {CONTACTS.map((c, i) => (
          ...
          >
            <a
              ...
              className="group block rounded-2xl border border-white/5 bg-[#161b22] p-8 text-center no-underline transition-all duration-300 hover:-translate-y-1 hover:border-[rgba(16,185,129,0.2)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.15)]"
            >
      ...
      <div className="mt-12 rounded-2xl bg-[#161b22] p-10 text-center">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2 text-[#10b981] no-underline transition-colors hover:text-[#34d399]"
        >
          <svg
            viewBox="0 0 24 24"
            fill="none"
