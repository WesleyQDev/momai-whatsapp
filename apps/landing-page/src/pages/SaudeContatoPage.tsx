...
export function SaudeContatoPage() {
  ...
  return (
    <div className="mx-auto max-w-[800px] px-8 py-24">
      ...
      <p className="mb-12 text-center text-lg text-[#8b949e]">
        ...
        {CONTACTS.map((c, i) => (
          ...
          >
            <a
              ...
              className="group block rounded-2xl border border-white/5 bg-[#161b22] p-8 text-center no-underline transition-all duration-300 hover:-translate-y-1 hover:border-[rgba(197,138,249,0.2)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.15)]"
            >
              <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-xl border border-white/10 bg-white/5">
                {c.icon}
              </div>
              <h3 className="mb-1 text-base font-medium text-[#e6edf3]">
                {c.title}
              </h3>
      ...
      <div className="mt-12 rounded-2xl bg-[#161b22] p-10 text-center">
        <h2 className="mb-3 font-flex text-2xl font-normal text-[#e6edf3]">
          Outras dúvidas?
        </h2>
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2 text-[#c58af9] no-underline transition-colors hover:text-[#d4a0f7]"
        >
          <svg
            viewBox="0 0 24 24"
            fill="none"
