  ...
  return (
    <div className="mx-auto flex min-h-[calc(100vh-200px)] max-w-[600px] flex-col items-center justify-center px-8 py-24">
      <h1
        ...
        style={{
          background: "var(--gradient-primary, linear-gradient(135deg, #c58af9 0%, #f981d3 100%))",
      ...
      <p className="mb-8 rounded-lg border border-white/10 bg-[rgba(197,138,249,0.1)] p-3 text-center text-sm text-[#8b949e]">
      ...
      >
        ...
        <div className="mb-6">
          ...
          <input
            ...
            required
            className="w-full rounded-lg border border-white/10 bg-[#0d1117] px-4 py-3 text-[#e6edf3] placeholder-[#484f58] transition-colors focus:border-[#c58af9] focus:outline-none focus:ring-2 focus:ring-[rgba(197,138,249,0.3)]"
          />
        </div>
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            required
            rows={5}
            className="w-full resize-vertical rounded-lg border border-white/10 bg-[#0d1117] px-4 py-3 text-[#e6edf3] placeholder-[#484f58] transition-colors focus:border-[#c58af9] focus:outline-none focus:ring-2 focus:ring-[rgba(197,138,249,0.3)]"
          />
        </div>

        <button
          type="submit"
          className="w-full cursor-pointer rounded-lg bg-white px-6 py-3 text-sm font-medium text-black transition-all hover:-translate-y-0.5 hover:shadow-[0_4px_12px_rgba(197,138,249,0.3)] active:translate-y-0 dark:bg-[#c58af9] dark:text-white"
        >
          Enviar Relatório
        </button>
