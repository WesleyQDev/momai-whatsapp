...
const CONTACTS = [
  {
    ...
    icon: (
      <svg
        ...
        className="h-6 w-6 stroke-[var(--accent)]"
      >
  ...
  return (
    <div className="mx-auto max-w-[800px] px-8 py-24">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        {CONTACTS.map((c) => (
          ...
          >
            ...
            <h3 className="mb-1 text-base font-medium text-[var(--text)]">
              {c.title}
            </h3>
      ...
      <div className="mt-12 rounded-2xl bg-[var(--bg-secondary)] p-10 text-center">
        <h2 className="mb-3 font-flex text-2xl font-normal text-[var(--text)]">
          {t("contato.outrasDuvidas")}
        </h2>
