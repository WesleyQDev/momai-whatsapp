...
export function HowItWorksSection() {
  ...
  return (
    <section
      id="how"
      className="how-section relative mx-auto max-w-[1100px] px-8 py-24"
    >
          ...
          <ScrollReveal key={i} delay={i * 0.15}>
            <div className="step relative text-center">
              <div className="step-number relative mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full border border-[rgba(197,138,249,0.2)] bg-[var(--bg-tertiary)] text-base font-medium text-[var(--accent)]">
                {step.number}
                <span
                  className="absolute inset-[-4px] rounded-full border border-[rgba(197,138,249,0.15)]"
                  style={{ animation: "pulse 2s ease-in-out infinite" }}
                />
              </div>
              <h3 className="mb-2 text-base font-medium text-[var(--text)]">
                {step.title}
              </h3>
