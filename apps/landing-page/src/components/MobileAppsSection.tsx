...
const MOBILE_APPS = [
  {
    ...
    name: "MomAI Saúde",
    description:
      "Monitore calorias, passos e hidratação com sua assistente de saúde pessoal. 100% privativo.",
    icon: HeartIcon,
  ...
  },
  {
    ...
    name: "MomAI Finanças",
    description:
      "Controle seus gastos, organize orçamentos e receba insights inteligentes sobre suas finanças.",
    icon: WalletIcon,
    image: "/icon.png",
    href: "#",
    color: "#8ab4f8",
  ...
  },
  {
    ...
    name: "MomAI Conectar",
    description:
      "Sincronize seu desktop com o celular. Acesse lembretes, notas e conversas em qualquer lugar.",
    icon: LinkIcon,
    image: "/icon.png",
    href: "#",
    color: "#f981d3",
          ...
          <ScrollReveal key={app.id} delay={i * 0.1}>
            <div
              className={`group relative overflow-hidden rounded-2xl border border-[var(--feature-border)] bg-[var(--bg-tertiary)] p-8 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(0,0,0,0.2)] ${
                app.available
                  ? "hover:border-[rgba(138,180,248,0.3)]"
                  : "opacity-70"
              }`}
            >
              <div
              ...
              <div className="relative z-[1]">
                <div className="mb-6 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <span
                      className={`text-xs font-semibold uppercase tracking-wide ${app.available ? "text-[var(--accent)]" : "text-[var(--text-tertiary)]"}`}
                    >
