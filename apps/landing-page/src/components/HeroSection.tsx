  ...
  return (
    <section className="hero relative mx-auto flex max-w-[900px] flex-col items-center justify-center px-8 pb-16 pt-12 text-center">
      <div className="hero-logo relative mx-auto mb-4 flex h-[180px] w-[180px] items-center justify-center md:h-[180px] md:w-[180px]">
        <div
          className="hero-logo-ring absolute left-1/2 top-1/2 z-[1] h-[180px] w-[180px] -translate-x-1/2 -translate-y-1/2 rounded-full before:absolute before:left-1/2 before:top-1/2 before:h-full before:w-full before:-translate-x-1/2 before:-translate-y-1/2 before:rounded-full before:border before:border-[var(--accent)] before:opacity-0 before:content-[''] after:absolute after:left-1/2 after:top-1/2 after:h-full after:w-full after:-translate-x-1/2 after:-translate-y-1/2 after:rounded-full after:border after:border-[var(--accent)] after:opacity-0 after:content-['']"
        ...
        <img
          src="/icon.gif"
          alt="MomAI"
          className="hero-logo-img relative z-[2] max-h-[160px] max-w-[160px] rounded-[20px] object-contain"
          loading="eager"
        />
      </div>

      <div
        className="badge mb-5 inline-block rounded-full border border-[rgba(138,180,248,0.2)] bg-[var(--gradient-subtle)] px-4 py-1 text-sm font-medium text-[var(--accent)]"
      ...
      <h1
        className="mb-6 font-flex text-5xl font-normal leading-[1.1] tracking-tight md:text-[4rem]"
        style={{
      ...
      <p
        className="subtitle mb-10 max-w-[700px] text-lg font-normal leading-relaxed text-[var(--text-secondary)]"
      ...
      <div
        className="btn-group flex items-start gap-3"
      ...
      >
          ...
          >
            {isLinux ? (
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
                className="relative z-[1] h-4 w-4 text-black"
              >
            ...
            {heroVersion && (
              <span className="relative z-[1] ml-2 text-sm font-normal opacity-70">
                {heroVersion}
              </span>
            )}
          </a>
        ...
        <Link
          to="/blog/post/v1-2-0"
          className="inline-flex items-center gap-1.5 rounded-full border border-[rgba(255,255,255,0.15)] bg-transparent px-6 py-[0.7rem] text-sm font-medium text-[var(--text-secondary)] no-underline transition-all hover:bg-[rgba(255,255,255,0.05)] hover:text-[var(--text)] hover:border-[rgba(255,255,255,0.25)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg)]"
        >
          {t("hero.saibaMais")}
        </Link>
      </div>
